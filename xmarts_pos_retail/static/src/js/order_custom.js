 ...
 */
odoo.define('xmarts_pos_retail.order_custom', function (require) {
    ...
    models.Order = models.Order.extend({
        initialize: function (attributes, options) {
            ...
            this.laundry_priority = 'normal';
            this.laundry_state = 'pendiente';
            var today = new Date();
        ...
        init_from_JSON: function (json) {
            ...
            if (json.laundry_priority) {
                this.laundry_priority = json.laundry_priority
            }
            if (json.laundry_state) {
                this.laundry_state = json.laundry_state
            }
            if (json.fechahora) {
                this.fechahora = json.fechahora
            }
            if (json.fechahorae) {
                this.fechahorae = json.fechahorae
            }
        ...
        export_as_JSON: function () {
            ...
            if (this.laundry_priority) {
                json.laundry_priority = this.laundry_priority;
            }
            if (this.laundry_state) {
                json.laundry_state = this.laundry_state;
            }
            if (this.fechahora) {
                json.fechahora = this.fechahora;
            }
            if (this.fechahorae) {
                json.fechahorae = this.fechahorae;
            }
            if (this.signature) {
            ...
            if (!this.ean13 && this.uid) {
                var ean13_code = "";
                ean13_code += this.zero_pad(this.pos.pos_session.id, 5) + this.zero_pad(this.pos.pos_session.login_number, 4) + this.zero_pad(this.sequence_number, 3);
                ...
                console.log('-> New Order with ean13: ' + this.ean13);
            }
        ...
        export_for_printing: function () {
            ...
            receipt['laundry_priority'] = order['laundry_priority'];
            receipt['laundry_state'] = this.laundry_state;
            receipt['fechahora'] = this.fechahora;
            receipt['fechahorae'] = this.fechahorae;
        ...
        zero_pad: function (num, size) {
            var s = "" + num;
            while (s.length < size) {
                s = Math.floor(Math.random() * 10).toString() + s;
            }
            return s;
        },
        ...
        get_note: function (note) {
            return this.note;
        },set_priority: function (laundry_priority) {
            this.laundry_priority = laundry_priority;
            this.trigger('change', this);
        },
        get_priority: function (laundry_priority) {
            return this.laundry_priority;
        },
        set_laundry_state: function (laundry_state) {
            this.laundry_state = laundry_state;
            this.trigger('change', this);
        },
        get_laundry_state: function (laundry_state) {
            return this.laundry_state;
        },
        set_fechahora: function (fechahora) {
            this.fechahora = fechahora;
            this.trigger('change', this);
        },
        get_fechahora: function (fechahora) {
            return this.fechahora;
        },
        set_fechahorae: function (fechahorae) {
            this.fechahorae = fechahorae;
            this.trigger('change', this);
        },
        get_fechahorae: function (fechahorae) {
            return this.fechahorae;
        },
